...
public class Node {
	...
	public Neighbor getNeighborByNode(Node nodeObj) {
		...
		for (int i = 0; i < neighborList.size(); i++) {
			if (neighborList.get(i).getNode().getNodeID().equals(nodeObj.getNodeID())) return neighborList.get(i);
		}
		return null;
	}
	...
	public Neighbor getNeighborByNodeID(String nodeID) {
		...
		for (int i = 0; i < neighborList.size(); i++) {
			if (neighborList.get(i).getNode().getNodeID().equals(nodeID)) return neighborList.get(i);
		}
		return null;
	}
