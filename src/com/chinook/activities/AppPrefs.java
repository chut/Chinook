...
public final class AppPrefs {
	...
	public static String getPOIdisplay_handicap(Context context) {
		prefs = PreferenceManager.getDefaultSharedPreferences(context);
		return prefs.getBoolean(PREFERENCE_POI_DISPLAY_HANDICAP, false)? "inline-block":"none";
	}
	...
	public static void setPOIdisplay_handicap(String display, Context context) {
		prefs = PreferenceManager.getDefaultSharedPreferences(context); 
		editor = prefs.edit(); 
		editor.putBoolean(PREFERENCE_POI_DISPLAY_HANDICAP, display.equals("inline-block"));
		editor.commit();
	}
	
	public static String getPOIdisplay_elevator(Context context) {
		prefs = PreferenceManager.getDefaultSharedPreferences(context);
		return prefs.getBoolean(PREFERENCE_POI_DISPLAY_ELEVATOR, true)? "inline-block":"none";
	}
	...
	public static void setPOIdisplay_elevator(String display, Context context) {
		prefs = PreferenceManager.getDefaultSharedPreferences(context); 
		editor = prefs.edit(); 
		editor.putBoolean(PREFERENCE_POI_DISPLAY_ELEVATOR, display.equals("inline-block"));
		editor.commit();
	}
	
	public static String getPOIdisplay_exit(Context context) {
		prefs = PreferenceManager.getDefaultSharedPreferences(context);
		return prefs.getBoolean(PREFERENCE_POI_DISPLAY_EXIT, true)? "inline-block":"none";
	}
	...
	public static void setPOIdisplay_exit(String display, Context context) {
		prefs = PreferenceManager.getDefaultSharedPreferences(context); 
		editor = prefs.edit(); 
		editor.putBoolean(PREFERENCE_POI_DISPLAY_EXIT, display.equals("inline-block"));
		editor.commit();
	}
	
	public static String getPOIdisplay_info(Context context) {
		prefs = PreferenceManager.getDefaultSharedPreferences(context);
		return prefs.getBoolean(PREFERENCE_POI_DISPLAY_INFO, false)? "inline-block":"none";
	}
	...
	public static void setPOIdisplay_info(String display, Context context) {
		prefs = PreferenceManager.getDefaultSharedPreferences(context); 
		editor = prefs.edit(); 
		editor.putBoolean(PREFERENCE_POI_DISPLAY_INFO, display.equals("inline-block"));
		editor.commit();
	}
	
	public static String getPOIdisplay_stairs(Context context) {
		prefs = PreferenceManager.getDefaultSharedPreferences(context);
		return prefs.getBoolean(PREFERENCE_POI_DISPLAY_STAIRS, true)? "inline-block":"none";
	}
	...
	public static void setPOIdisplay_stairs(String display, Context context) {
		prefs = PreferenceManager.getDefaultSharedPreferences(context); 
		editor = prefs.edit(); 
		editor.putBoolean(PREFERENCE_POI_DISPLAY_STAIRS, display.equals("inline-block"));
		editor.commit();
	}
	
	public static String getPOIdisplay_restroom(Context context) {
		prefs = PreferenceManager.getDefaultSharedPreferences(context);
		return prefs.getBoolean(PREFERENCE_POI_DISPLAY_RESTROOM, true)? "inline-block":"none";
	}
	...
	public static void setPOIdisplay_restroom(String display, Context context) {
		prefs = PreferenceManager.getDefaultSharedPreferences(context); 
		editor = prefs.edit(); 
		editor.putBoolean(PREFERENCE_POI_DISPLAY_RESTROOM, display.equals("inline-block"));
		editor.commit();
	}
	
	public static String getPOIdisplay_reception(Context context) {
		prefs = PreferenceManager.getDefaultSharedPreferences(context);
		return prefs.getBoolean(PREFERENCE_POI_DISPLAY_RECEPTION, false)? "inline-block":"none";
	}
	...
	public static void setPOIdisplay_reception(String display, Context context) {
		prefs = PreferenceManager.getDefaultSharedPreferences(context); 
		editor = prefs.edit(); 
		editor.putBoolean(PREFERENCE_POI_DISPLAY_RECEPTION, display.equals("inline-block"));
		editor.commit();
	}
	...
	public static String getPOIcolor_handicap(Context context) {
		prefs = PreferenceManager.getDefaultSharedPreferences(context);
		return prefs.getString(PREFERENCE_POI_COLOR_HANDICAP, "disability_purple.png");
	}
	...
	public static String getPOIcolor_elevator(Context context) {
		prefs = PreferenceManager.getDefaultSharedPreferences(context);
		return prefs.getString(PREFERENCE_POI_COLOR_ELEVATOR, "elevator_red.png");
	}
	...
	public static String getPOIcolor_info(Context context) {
		prefs = PreferenceManager.getDefaultSharedPreferences(context);
		return prefs.getString(PREFERENCE_POI_COLOR_INFO, "information_green.png");
	}
	...
	public static String getPOIcolor_restroom(Context context) {
		prefs = PreferenceManager.getDefaultSharedPreferences(context);
		return prefs.getString(PREFERENCE_POI_COLOR_RESTROOM, "toilets_yellow.png");
	}
	...
	public static String getPOIcolor_reception(Context context) {
		prefs = PreferenceManager.getDefaultSharedPreferences(context);
		return prefs.getString(PREFERENCE_POI_COLOR_RECEPTION, "waiting_blue.png");
	}
